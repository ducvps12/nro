...
# Cấu hình
$tieude = "Kỉ Niệm - Vũ Trụ Ngọc Rồng";
$server_name = "Vũ Trụ Ngọc Rồng";
$link_web = "http://nro.online/";

// Dùng đường dẫn tuyệt đối từ gốc site
$logo = "/chipasset/images/logo/logo.png";
$logotb = "/chipasset/images/logo/logo.png";

$gia_mtv = 1; // giá sẽ trừ vào thỏi vàng để mtv

# Đường dẫn tải phiên bản và box zalo
$java = "/taive/Nro.jar";
$pc   = "/taive/Nro.rar"; // Đặt tên file tránh khoảng trắng
$adr  = "/taive/Nro.apk";
$adr  = "/taive/Nro.apk";
$ios  = "/taive/Nro.ipa";
$tf   = "https://testflight.apple.com/join/fzwXefGu";
$box_zalo = "https://zalo.me/g/ggqfai124";
$fanpage  = "https://www.facebook.com/profile.php?id=61587820823937";
$Group    = "";
$tiktok   = "";

#DoiThe1s.VN API (Nếu có bán lại thì xoá key đi tránh lộ!)
$partner_id_config = ''; // TẠO Ở DOITHE1S
$partner_key_config = '';  // TẠO Ở DOITHE1S
...
$stkmbbank_config = '11'; // Số tài khoản 
